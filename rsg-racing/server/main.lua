...
RSGCore.Functions.CreateCallback('qb-racing:server:GetRacingLeaderboards', function(source, cb)
    local Leaderboard = {}
...
RSGCore.Functions.CreateCallback('qb-racing:server:GetRaces', function(source, cb)
    cb(AvailableRaces)
end)

RSGCore.Functions.CreateCallback('qb-racing:server:GetListedRaces', function(source, cb)
    cb(Races)
end)

RSGCore.Functions.CreateCallback('qb-racing:server:GetRacingData', function(source, cb, RaceId)
    cb(Races[RaceId])
end)

RSGCore.Functions.CreateCallback('qb-racing:server:HasCreatedRace', function(source, cb)
    cb(HasOpenedRace(RSGCore.Functions.GetPlayer(source).PlayerData.citizenid))
end)

RSGCore.Functions.CreateCallback('qb-racing:server:IsAuthorizedToCreateRaces', function(source, cb, TrackName)
    cb(IsPermissioned(RSGCore.Functions.GetPlayer(source).PlayerData.citizenid, 'create'), IsNameAvailable(TrackName))
end)

RSGCore.Functions.CreateCallback('qb-racing:server:GetTrackData', function(source, cb, RaceId)
