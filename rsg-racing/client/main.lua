            ...
            if PlayerVeh ~= 0 then
                ...
                if IsControlJustPressed(0, 162) or IsDisabledControlJustPressed(0, 162) then
                    if CreatorData.Checkpoints and next(CreatorData.Checkpoints) then
                        ...
                        RSGCore.Functions.Notify(Lang:t("error.no_checkpoints_to_delete"), 'error')
                    end
                end
...
RegisterNetEvent("qb-racing:Client:AvailableRacesMenu", function(data)
    RSGCore.Functions.TriggerCallback('qb-racing:server:GetRaces', function(Races)
        local menu = {
            {
                header = Lang:t("menu.available_races"),
                isMenuHeader = true
...
RegisterNetEvent("qb-racing:Client:RaceRecordsMenu", function(data)
    RSGCore.Functions.TriggerCallback('qb-racing:server:GetRacingLeaderboards', function(Races)
        local menu = {
            {
                header = Lang:t("menu.race_records"),
                isMenuHeader = true
...
RegisterNetEvent("qb-racing:Client:SetupRaceMenu", function(data)
    RSGCore.Functions.TriggerCallback('qb-racing:server:GetListedRaces', function(Races)
...
RegisterNetEvent("qb-racing:Client:CreateRaceMenu", function(data)
    ...
    RSGCore.Functions.TriggerCallback('qb-racing:server:IsAuthorizedToCreateRaces', function(IsAuthorized, NameAvailable)
